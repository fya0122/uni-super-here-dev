...
var aXC=_mz(z,'input',['bindconfirm',6,'class',1,'confirmType',2,'data-event-opts',3,'maxlength',4,'placeholder',5,'type',6],[],e,s,gg)
cs.pop()
_(cUC,aXC)
cs.pop()
_(oTC,cUC)
...
var c6C=_n('view')
_rz(z,c6C,'class',18,x3C,o2C,gg)
cs.push("./pages/search/search.wxml:image:1:620")
var h7C=_mz(z,'image',['class',19,'src',1],[],x3C,o2C,gg)
cs.pop()
_(c6C,h7C)
cs.pop()
_(o4C,c6C)
...
eZC.wxXCkey=2
_2z(z,16,b1C,e,s,gg,eZC,'item','__i0__','id')
cs.pop()
cs.pop()
_(oTC,tYC)
cs.pop()
