...
<script>
	...
	export default {
		...
		onLoad(params) {
			let imageSrc = params.tempFilePath;
		...
		methods: {
			...
			getImageInfo() {
				...
				ctx.draw(true, (() => {
					...
					let canvasW = ((this.cropperW - this.cutL - this.cutR) / this.cropperW) * IMG_REAL_W;
					let canvasH = ((this.cropperH - this.cutT - this.cutB) / this.cropperH) * IMG_REAL_H;
					let canvasL = (this.cutL / this.cropperW) * IMG_REAL_W;
					let canvasT = (this.cutT / this.cropperH) * IMG_REAL_H;
					uni.canvasToTempFilePath({
						...
						success: ((res) => {
							...
							uni.uploadFile({
								url: common.api_base_url + '/user/uploadFace?userId=' + this.globalUser.id + '&qq=' + common.qq,
